...
exec(open(os.path.join(HERE, 'glnem', 'version.py')).read())
...
URL = 'https://joshloyal.github.io/glnem'
DOWNLOAD_URL = 'https://pypi.org/project/glnem/#files'
LICENSE = 'MIT'
VERSION = __version__
CLASSIFIERS = []
...
def setup_package():
    ...
    with chdir(HERE):
        ...
        setup(
            ...
            package_data={
                '': [
                    'glnem' + os.path.sep + '*.pyx',
                    'glnem' + os.path.sep + '.pxd'
                ]
            },
